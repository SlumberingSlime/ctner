...
// 容器执行的第一个进程，使用mount挂载proc文件系统
// 方便后续用ps等系统命令，查看当前进程资源的情况
...
func readUserCommand() []string {
	//指的是index为3的文件描述符，cmd.Extrafiles传过来的readPipe
	//process.go文件末尾
...
func setUpMount() error {
	...
	//system加入linux后，mount namespace变成shared by default
	//需要显式声明需要新的mount namespace独立
